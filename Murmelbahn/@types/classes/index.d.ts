...
declare class BlockCore {
    ...
    draw(): void;
    drawBody(): void;
    drawVertices(vertices: any): void;
}
/**
...
declare class BlocksFromSVG {
    constructor(world: any, file: any, blocks: any, options: any);
    blocks: any;
    world: any;
    options: any;
    promise: any;
...
<a target="_blank" href="https://github.com/b-g/p5-matter-examples/blob/master/xx-benno-step7/sketch.js">open code</a>
*/
declare class PolygonFromPoints {
    constructor(world: any, attributes: any, options: any);
    addBody(): void;
    body: any;
}
...
*/
declare class PolygonFromSVG {
    constructor(world: any, attributes: any, options: any);
    addBody(): void;
    addBodyVertices(vertices: any): void;
    body: any;
    offset: any;
    getCenter(vertices: any): {
        x: number;
        y: number;
    };
}
